...
#The steps below can be commented out once the .dat file with scenairo outputs has been created
...
#----------------------------------------------- SECTION 6: NEIGHBOR REGIONS ------------------------------------------------
  #To run WRF-CMAQ we will need emission changes in neighboring regions. We will apply multipliers from GCAM at a pollutant level, per scenario and period.
